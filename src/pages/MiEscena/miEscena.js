...
function crearElementoPublicacion(datosPublicacion) {
  ...
  boton1.classList.add("boton", "flat","mejora");
  var icono1 = document.createElement("span");
  icono1.classList.add("material-symbols-outlined", "icono");
  icono1.textContent = "artist";
  var texto1 = document.createElement("span");
  texto1.classList.add("texto");
  texto1.textContent = "Me entona";
  ...
  boton3.classList.add("boton", "flat","mejora");
  var icono3 = document.createElement("span");
  icono3.classList.add("material-symbols-outlined", "icono");
  icono3.textContent = "adaptive_audio_mic";
  var boton3 = document.createElement("button");
  boton3.classList.add("boton", "flat");
  boton3.textContent = "Colaborar";
  var artistaIcono = document.createElement("span");
  artistaIcono.classList.add("material-symbols-outlined");
  artistaIcono.hidden = true;
